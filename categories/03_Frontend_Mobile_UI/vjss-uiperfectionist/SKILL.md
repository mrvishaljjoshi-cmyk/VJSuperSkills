...
description: >-
  Use this skill for UI/UX Visual Auditing, Cross-Device QA & Interaction Polish (Frontend Frameworks, Mobile Apps & Responsive UI/UX).
---

# 🌟 VJSS Protocol: Uiperfectionist
**Domain:** `UI/UX Visual Auditing, Cross-Device QA & Interaction Polish`
