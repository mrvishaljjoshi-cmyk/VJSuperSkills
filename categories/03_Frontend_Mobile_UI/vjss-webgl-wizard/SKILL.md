---
name: vjss-webgl-wizard
description: >-
  Use this skill for Three.js, WebGL 3D Shaders & Browser Canvas Rendering (Frontend Frameworks, Mobile Apps & Responsive UI/UX).
---

# 🌟 VJSS Protocol: WebglWizard
**Domain:** `Three.js, WebGL 3D Shaders & Browser Canvas Rendering`
