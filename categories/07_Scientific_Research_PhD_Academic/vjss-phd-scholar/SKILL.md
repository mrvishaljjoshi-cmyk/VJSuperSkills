---
name: vjss-phd-scholar
description: >-
  Use this skill for PhD Doctoral Research, 6-Chapter Dissertation Scaffolding & PRISMA Reviews (PhD Doctoral Research, Academic Publishing & Bioinformatics).
---

# 🌟 VJSS Protocol: PhdScholar
...
1. **Absolute Determinism:** Every component in `PhdScholar` must produce predictable, idempotent outputs given identical inputs.
