---
name: vjss-scientific-paper-writer
description: >-
  Use this skill for Scientific Paper Writing, IMRaD Journal Drafting & LaTeX Formatting (PhD Doctoral Research, Academic Publishing & Bioinformatics).
---

# 🌟 VJSS Protocol: ScientificPaperWriter
...
1. **Absolute Determinism:** Every component in `ScientificPaperWriter` must produce predictable, idempotent outputs given identical inputs.
