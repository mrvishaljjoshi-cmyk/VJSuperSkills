---
name: vjss-bioinformatics-expert
description: >-
  Use this skill for Computational Biology, Genomics, Proteomics & Biopython Pipelines (PhD Doctoral Research, Academic Publishing & Bioinformatics).
---

# 🌟 VJSS Protocol: BioinformaticsExpert
...
1. **Absolute Determinism:** Every component in `BioinformaticsExpert` must produce predictable, idempotent outputs given identical inputs.
