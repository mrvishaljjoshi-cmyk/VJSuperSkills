---
name: vjss-infra-director
description: >-
  Use this skill for Enterprise Multi-Cloud Infrastructure Governance & Zero-Bill Architecture (Backend APIs, Cloud Always-Free Tier, Docker & Microservices).
---

# 🌟 VJSS Protocol: InfraDirector
...
1. **Absolute Determinism:** Every component in `InfraDirector` must produce predictable, idempotent outputs given identical inputs.
