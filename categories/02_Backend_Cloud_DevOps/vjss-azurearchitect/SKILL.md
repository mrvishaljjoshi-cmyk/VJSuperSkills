---
name: vjss-azurearchitect
description: >-
  Use this skill for Azure Cloud Services, App Services & Cosmos DB (Backend APIs, Cloud Always-Free Tier, Docker & Microservices).
---

# 🌟 VJSS Protocol: Azurearchitect
**Domain:** `Azure Cloud Services, App Services & Cosmos DB`
