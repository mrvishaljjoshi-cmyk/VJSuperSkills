---
name: vjss-datacenter-sme
description: >-
  Use this skill for Principal Enterprise Datacenter Architecture, VMware ESXi & SAN Storage (Backend APIs, Cloud Always-Free Tier, Docker & Microservices).
---

# 🌟 VJSS Protocol: DatacenterSme
...
1. **Absolute Determinism:** Every component in `DatacenterSme` must produce predictable, idempotent outputs given identical inputs.
