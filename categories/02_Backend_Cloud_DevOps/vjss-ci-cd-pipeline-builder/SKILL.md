---
name: vjss-ci-cd-pipeline-builder
description: >-
  Use this skill for CI/CD Automation, GitHub Actions & Quality Gates (Backend APIs, Cloud Always-Free Tier, Docker & Microservices).
---

# 🌟 VJSS Protocol: CiCdPipelineBuilder
**Domain:** `CI/CD Automation, GitHub Actions & Quality Gates`
