---
name: vjss-rustbackend
description: >-
  Use this skill for Rust Actix/Axum Backend Development & Memory Safety (Backend APIs, Cloud Always-Free Tier, Docker & Microservices).
---

# 🌟 VJSS Protocol: Rustbackend
**Domain:** `Rust Actix/Axum Backend Development & Memory Safety`
