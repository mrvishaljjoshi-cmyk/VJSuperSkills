---
name: vjss-iam-policy-expert
description: >-
  Use this skill for Least-Privilege IAM Policies, Cloud RBAC & Security Hardening (Backend APIs, Cloud Always-Free Tier, Docker & Microservices).
---

# 🌟 VJSS Protocol: IamPolicyExpert
**Domain:** `Least-Privilege IAM Policies, Cloud RBAC & Security Hardening`
