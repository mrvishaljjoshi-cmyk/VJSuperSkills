---
name: vjss-fullstack-l3-lead
description: >-
  Use this skill for L3 Full-Stack Systems Lead, Complex Microservices & Low-Latency APIs (Backend APIs, Cloud Always-Free Tier, Docker & Microservices).
---

# 🌟 VJSS Protocol: FullstackL3Lead
...
1. **Absolute Determinism:** Every component in `FullstackL3Lead` must produce predictable, idempotent outputs given identical inputs.
