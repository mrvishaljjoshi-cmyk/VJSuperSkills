---
name: vjss-infra-l2-automation
description: >-
  Use this skill for L2 Infrastructure Automation, Automated Patching & Backup Snapshots (Backend APIs, Cloud Always-Free Tier, Docker & Microservices).
---

# 🌟 VJSS Protocol: InfraL2Automation
...
1. **Absolute Determinism:** Every component in `InfraL2Automation` must produce predictable, idempotent outputs given identical inputs.
