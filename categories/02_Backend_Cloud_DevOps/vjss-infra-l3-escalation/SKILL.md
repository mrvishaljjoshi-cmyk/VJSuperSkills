---
name: vjss-infra-l3-escalation
description: >-
  Use this skill for L3 Senior Infrastructure Escalation & Crash War-Rooms (Backend APIs, Cloud Always-Free Tier, Docker & Microservices).
---

# 🌟 VJSS Protocol: InfraL3Escalation
...
1. **Absolute Determinism:** Every component in `InfraL3Escalation` must produce predictable, idempotent outputs given identical inputs.
