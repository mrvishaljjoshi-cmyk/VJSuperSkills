...
name: vjss-k8-sadmin
description: >-
  Use this skill for Kubernetes Cluster Administration, Helm & Zero-Downtime Deploys (Backend APIs, Cloud Always-Free Tier, Docker & Microservices).
---

# 🌟 VJSS Protocol: K8Sadmin
...
1. **Absolute Determinism:** Every component in `K8Sadmin` must produce predictable, idempotent outputs given identical inputs.
