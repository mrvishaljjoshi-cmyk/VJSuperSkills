---
name: vjss-infra-l1-monitoring
description: >-
  Use this skill for L1 24x7 Datacenter Operations & Telemetry Alert Triage (Backend APIs, Cloud Always-Free Tier, Docker & Microservices).
---

# 🌟 VJSS Protocol: InfraL1Monitoring
...
1. **Absolute Determinism:** Every component in `InfraL1Monitoring` must produce predictable, idempotent outputs given identical inputs.
