---
name: vjss-geminiapidev
description: >-
  Use this skill for Google Gemini API, Multimodal Prompts & Structured Outputs (AI, Machine Learning, Data Science & Vector Databases).
---

# 🌟 VJSS Protocol: Geminiapidev
**Domain:** `Google Gemini API, Multimodal Prompts & Structured Outputs`
