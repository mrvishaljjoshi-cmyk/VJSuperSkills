---
name: vjss-ai-research-director
description: >-
  Use this skill for Head of Quantitative Research, AI Strategy & Model Governance (AI, Machine Learning, Data Science & Vector Databases).
---

# 🌟 VJSS Protocol: AiResearchDirector
...
1. **Absolute Determinism:** Every component in `AiResearchDirector` must produce predictable, idempotent outputs given identical inputs.
