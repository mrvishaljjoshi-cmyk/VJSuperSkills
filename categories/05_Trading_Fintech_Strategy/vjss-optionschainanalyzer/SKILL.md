---
name: vjss-optionschainanalyzer
description: >-
  Use this skill for Options Chain Greeks (Delta, Gamma, Theta), PCR & Max Pain (Quantitative Finance, Dynamic Rally Riding & Backtesting).
---

# 🌟 VJSS Protocol: Optionschainanalyzer
**Domain:** `Options Chain Greeks (Delta, Gamma, Theta), PCR & Max Pain`
