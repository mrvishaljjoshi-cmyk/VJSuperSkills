---
name: vjss-quant-science-sme
description: >-
  Use this skill for Principal Quant SME, Dynamic Rally Riding & Dynamic ATR State Machine (Quantitative Finance, Dynamic Rally Riding & Backtesting).
---

# 🌟 VJSS Protocol: QuantScienceSme
...
1. **Absolute Determinism:** Every component in `QuantScienceSme` must produce predictable, idempotent outputs given identical inputs.
