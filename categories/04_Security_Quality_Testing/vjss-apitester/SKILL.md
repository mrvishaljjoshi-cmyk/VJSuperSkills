...
name: vjss-apitester
description: >-
  Use this skill for REST & GraphQL Automated API Contract Testing (OWASP Security, Penetration Testing & Comprehensive QA).
---

# 🌟 VJSS Protocol: Apitester
**Domain:** `REST & GraphQL Automated API Contract Testing`
