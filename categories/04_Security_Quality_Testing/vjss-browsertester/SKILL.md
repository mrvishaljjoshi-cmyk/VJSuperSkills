---
name: vjss-browsertester
description: >-
  Use this skill for Headless Browser Automation (Playwright/Puppeteer) (OWASP Security, Penetration Testing & Comprehensive QA).
---

# 🌟 VJSS Protocol: Browsertester
**Domain:** `Headless Browser Automation (Playwright/Puppeteer)`
