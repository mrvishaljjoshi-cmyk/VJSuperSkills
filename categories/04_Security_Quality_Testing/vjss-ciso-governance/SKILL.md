---
name: vjss-ciso-governance
description: >-
  Use this skill for CISO Information Security Governance, ISO 27001 & SOC2 (OWASP Security, Penetration Testing & Comprehensive QA).
---

# 🌟 VJSS Protocol: CisoGovernance
...
1. **Absolute Determinism:** Every component in `CisoGovernance` must produce predictable, idempotent outputs given identical inputs.
