---
name: vjss-privacy-airgap-shield
description: >-
  Use this skill for Zero-Data-Leakage Prompt Guard & Path Sanitization (OWASP Security, Penetration Testing & Comprehensive QA).
---

# 🌟 VJSS Protocol: PrivacyAirgapShield
...
1. **Absolute Determinism:** Every component in `PrivacyAirgapShield` must produce predictable, idempotent outputs given identical inputs.
