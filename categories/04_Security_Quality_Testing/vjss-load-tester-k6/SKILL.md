---
name: vjss-load-tester-k6
description: >-
  Use this skill for k6 Load Testing, Stress Benchmarking & Throughput Analysis (OWASP Security, Penetration Testing & Comprehensive QA).
---

# 🌟 VJSS Protocol: LoadTesterK6
**Domain:** `k6 Load Testing, Stress Benchmarking & Throughput Analysis`
