---
name: vjss-e2-ecypress
description: >-
  Use this skill for Cypress End-to-End Automated Browser Testing (OWASP Security, Penetration Testing & Comprehensive QA).
---

# 🌟 VJSS Protocol: E2Ecypress
...
1. **Absolute Determinism:** Every component in `E2Ecypress` must produce predictable, idempotent outputs given identical inputs.
