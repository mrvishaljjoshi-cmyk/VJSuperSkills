---
name: vjss-universal-project-adapter
description: >-
  Use this skill for Universal Context Sensing & Client Coding Standard Matching (Master Autonomous Orchestration, SysAdmin & Optimization).
---

# 🌟 VJSS Protocol: UniversalProjectAdapter
...
1. **Absolute Determinism:** Every component in `UniversalProjectAdapter` must produce predictable, idempotent outputs given identical inputs.
