---
name: vjss-kaizen-sme
description: >-
  Use this skill for Japanese Kaizen Continuous Improvement & 5-Whys Root Cause Analysis (Master Autonomous Orchestration, SysAdmin & Optimization).
---

# 🌟 VJSS Protocol: KaizenSme
...
1. **Absolute Determinism:** Every component in `KaizenSme` must produce predictable, idempotent outputs given identical inputs.
